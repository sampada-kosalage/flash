...
<body>
<center>
<form  id="P1form"  onsubmit="return validate()" action = "AddP1" method ="post">
<% 	lookup l=lookup.getlookup(); 
	...
	if(fn.equals("Add"))
	{
		id=String.valueOf(l.getmaxrows("P1")+1);
	...
	else
	{
		try
		{
			l.getrs("Select * from P1 where id="+id);
			if(l.rs!=null)
			if(l.rs.next()){
				id=l.rs.getString("id");
				//<!-- RECORD DATA ---------- -->
				//AddZ.jsp02 COL=l.rs.getString(COLNO);
				P1C1=l.rs.getString("P1C1");
				P1C2=l.rs.getString("P1C2");
				P1C3=l.rs.getString("P1C3");
			}
		}
		catch(Exception e){
...
<tr><td>P1C1</td><td><input type='text' name="P1C1" value="<%=P1C1%>"></td></tr>
<tr><td>P1C2</td><td><input type='text' name="P1C2" value="<%=P1C2%>"></td></tr>
<tr><td>P1C3</td><td><input type='text' name="P1C3" value="<%=P1C3%>"></td></tr>
