...
/**
 * Servlet implementation class AddT2
 */
@WebServlet("/AddT2")
public class AddT2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String T2C1=request.getParameter("T2C1");
		String T2C2=request.getParameter("T2C2");
		String T2C3=request.getParameter("T2C3");
		...
		try 
		{
			...
			int rv=dao.addT2Details(fn,Integer.parseInt(id)
					//AddZ.java03 ,COL
						,T2C1
						,T2C2
						,T2C3
