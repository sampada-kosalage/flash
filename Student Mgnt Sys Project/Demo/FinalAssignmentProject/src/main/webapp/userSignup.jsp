...
<body>
	...
	<table class="center" border="0"> <tr> 
		...
		<tr> <td><font color=white>Email:</font><input type="text" name="email"/><br/></td> </tr>
		<tr> <td><font color=white>Phone Number:</font><input type="text" name="phoneNumber"/><br/></td> </tr>
